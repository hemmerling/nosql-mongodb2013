...
print ( "m102, week 5, hw5.1 - Solution" )
query
query.explain()
// Create an index which speeds up the query
// db.sensor_readings.dropIndex("*")
db.sensor_readings.dropIndexes()
homework.a()
db.sensor_readings.ensureIndex({"tstamp":1})
homework.a()
db.sensor_readings.ensureIndex({"tstamp":-1})
homework.a()
